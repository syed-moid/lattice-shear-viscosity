...
of SrTiO3 from first-principles anharmonic lattice dynamics* (with a
data-anchored extension to the critical soft sector of BaTiO3, denoted
eta_44^soft). The `latvisc` package performs a mode-resolved evaluation of
...
are computed throughout for SrTiO3; for BaTiO3 the soft-mode frequencies
...
2. Anharmonic lattice-dynamics runs (ALAMODE SCPH-coupled RTA for SrTiO3;
