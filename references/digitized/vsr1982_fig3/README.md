...
- closed circles = VSR this-work (hyper-Raman):
    omega0_vsr1982_thiswork.csv (12 pts), rel_damping_vsr1982_thiswork.csv (12 pts)
- open circles = VSR Ref. 14 = Y. Luspin, J. L. Servoin, and F. Gervais,
  J. Phys. C: Solid State Phys. 13, 3761 (1980) (infrared reflectivity;
  the Luspin dataset recovered via this compilation):
    omega0_luspin1980.csv (6 pts), rel_damping_luspin1980.csv (6 pts)
- crosses = VSR Ref. 13 = A. S. Barker, Jr., Phys. Rev. 145, 391 (1966):
    omega0_barker1966.csv (3 pts), rel_damping_barker1966.csv (3 pts)

Combined_vsr1982_fig3_rel_damping.csv = superseded single-file export of
the three rel_damping series concatenated (21 = 6+12+3 rows); retained
for provenance, not consumed by any script.

Digitization: WebPlotDigitizer, by Syed Moid, received 2026-07-24.
Deliberate omissions: none for this figure (error bars not captured).
